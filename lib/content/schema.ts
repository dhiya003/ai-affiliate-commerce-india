...
export const contentBundleSchema = z.object({
  ...
  storyFrames: z.array(shortText).min(3).max(5).optional(),
  creativeImagePrompt: longText.optional(),
  landingPageHeadline: shortText.optional(),
  landingPageBody: longText.optional(),
  landingPageBullets: z.array(shortText).min(3).max(6).optional(),
